"""CONTROL DE FP v11.10 — Estabilización de sesgo y ajuste fino de banda muerta (Objetivo: PF = 1.0)"""
import sys
import time
...
# Configuración optimizada para Factor de Potencia = 1.0
FP_OBJETIVO  = 1.0
PHI_OBJETIVO = 0.0   # cos(0°) = 1.0
FP_OBJETICO  = FP_OBJETIVO  # Alias preventivo por compatibilidad

FP_MIN_RANGO, FP_MAX_RANGO  = 0.95, 1.00
FP_TIGHT_LOW, FP_TIGHT_HIGH = 0.98, 1.00
PHI_TIGHT = 0.58
...
# Umbrales y pasos optimizados para enganchar PLL en FP = 1.0
PHI_BUSCAR_ENTER, PHI_BUSCAR_EXIT = 25.0, 15.0
N_FRESH_ENTER_BUSCAR, N_FRESH_EXIT_BUSCAR = 3, 3
PASO_BUSCAR_INICIAL, PASO_BUSCAR_MIN, PASO_BUSCAR_MAX = 8.0, 2.0, 12.0
N_SETTLE_BUSCAR = 6

# Ganancias y parámetros dinámicos optimizados
...
# Banda muerta ajustada y cooldown optimizado
...
class ControladorFP:
    ...
    def _buscar(self, fresh):
        ...
        # Aproximación proporcional suave hacia 0.0°
...
def main():
    ...
    try:
        ...
        # Configuración inicial del canal 1 del generador FG420
        ...
        print(f"\n{'t (s)':>6} | {'FP Medido':>10} | {'|FP-1.0|':>10} | {'Modo':>7} | {'Acción':>20}")
        print("-" * 65)
